...
DIG Network L2 protocol types — superset of [`chia-protocol`](https://crates.io/crates/chia-protocol) with extension opcodes **200–226** — plus `DigLink`, the websocket peer link that can actually carry them.

...
### Features
- **link:** Give the rate limiter a direction, and report a junk reply as InvalidResponse (#8)

## [0.8.0] - 2026-08-26

### Chores
- **deps:** Adopt the chia-sdk-client 0.36.0 ceiling (#12)
...
### Features
- **opcodes:** Assign 223/224/225 for profile-SMT sync (#9)
